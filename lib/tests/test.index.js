...
describe('test vapjs-format object', function () {
  describe('test formatQuantity', function () {
    it('should encode normally', function () {
      ...
      var prefixHexNumber = '0x021d21a2';
      var nullNumber = null;
  ...
  describe('test decode of getBlockByNumber', function () {
    ...
    var formattedData = format.formatOutputs('vap_getBlockByHash', payload);
  ...
  describe('test formatInputs', function () {
    it('should handle vap_getBalance normally', function () {
      var encodedBalance = format.formatInputs('vap_getBalance', ['0xb60e8dd61c5d32be8058bb8eb970870f07233155']);

      assert.equal(encodedBalance, '0xb60e8dd61c5d32be8058bb8eb970870f07233155');
    });

    it('should handle vap_getBalance 2 arguments normally', function () {
      var encodedBalance = format.formatInputs('vap_getBalance', ['0xb60e8dd61c5d32be8058bb8eb970870f07233155', 'latest']);

      assert.equal(encodedBalance[0], '0xb60e8dd61c5d32be8058bb8eb970870f07233155');
      assert.equal(encodedBalance[1], 'latest');
    });

    it('should handle vap_sendTransaction normally', function () {
      var encodedSendTransaction = format.formatInputs('vap_sendTransaction', [{
        'from': '0xb60e8dd61c5d32be8058bb8eb970870f07233155',
        'to': '0xd46e8dd67c5d32be8058bb8eb970870f07244567',
        'gas': new BN('30400'), // 30400,
        'gasPrice': '10000000000000', // 10000000000000
  ...
  describe('test formatOutputs', function () {
    it('should handle invalid vap_getTransactionByBlockHashAndIndex normally', function () {
      try {
        var decodedHashRate = format.formatInputs('vap_getTransactionByBlockHashAndIndex', ['0x']);
      } catch (error) {
        assert.equal(typeof error, 'object');
      }
    });

    it('should handle vap_getFilterChanges normally during vap_newBlockFilter', function () {
      var decodedTxHashArray = format.formatOutputs('vap_getFilterChanges', ['0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55', '0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55']);
    ...
    it('should handle vap_getFilterChanges normally during vap_newPendingTransactionFilter', function () {
      var decodedTxHashArray = format.formatOutputs('vap_getFilterChanges', ['0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55', '0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55']);

      assert.equal(decodedTxHashArray.toString(10), ['0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55', '0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55']);
    });

    it('should handle vap_hashrate normally', function () {
      var decodedHashRate = format.formatOutputs('vap_hashrate', '0x38a');

      assert.equal(decodedHashRate.toString(10), '906');
    });

    it('should handle vap_getBalance normally', function () {
      var decodedBalance = format.formatOutputs('vap_getBalance', '0x38a');

      assert.equal(decodedBalance.toString(10), '906');
    });

    it('should handle empty vap_hashrate normally', function () {
      var decodedHashRate = format.formatOutputs('vap_hashrate', '0x');

      assert.equal(decodedHashRate.toString(10), '0');
    });

    it('should handle vap_mining true normally', function () {
      var decodedMining = format.formatOutputs('vap_mining', true);

      assert.equal(decodedMining, true);
    });

    it('should handle vap_mining false normally', function () {
      var decodedMining = format.formatOutputs('vap_mining', false);

      assert.equal(decodedMining, false);
    });

    it('should handle vap_accounts normally', function () {
      var decodedVapAccounts = format.formatOutputs('vap_accounts', ['0x407d73d8a49eeb85d32cf465507dd71d507100c1', '0x407d73d8a49eeb85d32cf465507dd71d507100c1', '0x407d73d8a49eeb85d32cf465507dd71d507100c1']);
    ...
    it('should handle empty vap_accounts normally', function () {
      var decodedVapAccounts = format.formatOutputs('vap_accounts', []);

      assert.equal(decodedVapAccounts.length, 0);
    });

    it('should handle vap_getFilterChanges normally', function () {
      var decodedFilterChanges = format.formatOutputs('vap_getFilterChanges', [{
        'logIndex': '0x1', // 1
        'blockNumber': '0x1b4', // 436
